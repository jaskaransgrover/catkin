...
"""autogenerated by genpy from robosar_controller/RobosarControllerGoal.msg. Do not edit."""
import codecs
import sys
...
class RobosarControllerGoal(genpy.Message):
  _md5sum = "2d764ee62a71f032665047c211608c2e"
  _type = "robosar_controller/RobosarControllerGoal"
...
float64 w
"""
  __slots__ = ['agent_name','path']
  _slot_types = ['string','nav_msgs/Path']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RobosarControllerGoal, self).__init__(*args, **kwds)
