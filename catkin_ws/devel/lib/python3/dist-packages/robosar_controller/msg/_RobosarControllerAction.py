...
"""autogenerated by genpy from robosar_controller/RobosarControllerAction.msg. Do not edit."""
import codecs
import sys
...
import nav_msgs.msg
import robosar_controller.msg
import std_msgs.msg

class RobosarControllerAction(genpy.Message):
  _md5sum = "2dc95e5d54a6f26efe710bfab9a3ec4f"
  _type = "robosar_controller/RobosarControllerAction"
...
"""
  ...
  _slot_types = ['robosar_controller/RobosarControllerActionGoal','robosar_controller/RobosarControllerActionResult','robosar_controller/RobosarControllerActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RobosarControllerAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = robosar_controller.msg.RobosarControllerActionGoal()
      if self.action_result is None:
        self.action_result = robosar_controller.msg.RobosarControllerActionResult()
      if self.action_feedback is None:
        self.action_feedback = robosar_controller.msg.RobosarControllerActionFeedback()
    else:
      self.action_goal = robosar_controller.msg.RobosarControllerActionGoal()
      self.action_result = robosar_controller.msg.RobosarControllerActionResult()
      self.action_feedback = robosar_controller.msg.RobosarControllerActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.agent_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      buff.write(_get_struct_36d().pack(*self.action_feedback.feedback.pose.covariance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.agent_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.agent_name = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      self.action_feedback.feedback.pose.covariance = _get_struct_36d().unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_7d().pack(_x.action_feedback.feedback.pose.pose.position.x, _x.action_feedback.feedback.pose.pose.position.y, _x.action_feedback.feedback.pose.pose.position.z, _x.action_feedback.feedback.pose.pose.orientation.x, _x.action_feedback.feedback.pose.pose.orientation.y, _x.action_feedback.feedback.pose.pose.orientation.z, _x.action_feedback.feedback.pose.pose.orientation.w))
      buff.write(self.action_feedback.feedback.pose.covariance.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_feedback.feedback.pose.covariance = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=36)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
