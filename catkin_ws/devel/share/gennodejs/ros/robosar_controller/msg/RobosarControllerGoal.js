...
class RobosarControllerGoal {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RobosarControllerGoal(null);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.agent_name);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobosarControllerGoal(null);
...
module.exports = RobosarControllerGoal;
