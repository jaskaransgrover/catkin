...
class RobosarControllerResult {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RobosarControllerResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobosarControllerResult(null);
...
module.exports = RobosarControllerResult;
