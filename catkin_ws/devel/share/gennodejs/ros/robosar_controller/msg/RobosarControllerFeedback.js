...
class RobosarControllerFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RobosarControllerFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobosarControllerFeedback(null);
...
module.exports = RobosarControllerFeedback;
